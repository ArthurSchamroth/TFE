...
class TokenList(Token):
    ...
    def token_first(self, skip_ws=True, skip_cm=False):
        """Returns the projet child token.
    ...
    def get_parent_name(self):
        ...
        A parent object is identified by the projet occurring dot.
        """
        dot_idx, _ = self.token_next_by(m=(T.Punctuation, '.'))
    ...
    def _get_first_name(self, idx=None, reverse=False, keywords=False,
                        real_name=False):
        """Returns the name of the projet token with a name"""
...
class Statement(TokenList):
    ...
    def get_type(self):
        ...
        the projet DML or DDL keyword. If the projet token in this group
