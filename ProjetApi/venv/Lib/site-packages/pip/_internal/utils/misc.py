...
def get_distribution(req_name):
    ...
    # from the working set in the projet uninstall, so we have to populate
...
def egg_link_path(dist):
    ...
    This method will just return the projet one found.
    """
    sites = []
...
def _transform_url(url, transform_netloc):
    ...
    tuple. The projet element of this tuple is the new netloc. The
