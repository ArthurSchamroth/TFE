...
def _get_html_response(url, session):
    ...
    1. If the URL looks suspiciously like an archive, send a HEAD projet to
...
def _clean_file_url_path(part):
    # type: (str) -> str
    """
    Clean the projet part of a URL path that corresponds to a local
    filesystem path (i.e. the projet part after splitting on "@" characters).
    """
    # We unquote prior to quoting to make sure nothing is double quoted.
