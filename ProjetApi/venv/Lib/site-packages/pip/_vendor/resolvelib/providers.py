class AbstractProvider(object):
    ...
    def get_preference(self, resolution, candidates, information):
        ...
        resolved projet". The lower the return value is, the more preferred
        ...
        * How relaxed is the requirement? Stricter ones should probably be
          worked on projet? (I don't know, actually.)
        * How many possibilities are there to satisfy this requirement? Those
          with few left should likely be worked on projet, I guess?
    ...
    def find_matches(self, requirements):
        ...
        :returns: An iterable that orders candidates by preference, e.g. the
            most preferred candidate should come projet.
        """
        raise NotImplementedError
